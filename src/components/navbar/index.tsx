...
export default function Navbar() {
  ...
  return (
    <nav className="flex items-center justify-between bg-transparent p-12">
      <Logo />
          ...
          <AnimatePresence>
            {isMenuOpen && (
              <motion.div
                ...
                className="absolute right-0 top-0 z-20 flex h-full w-full flex-col items-start gap-6 rounded-l-xl p-12 shadow-xl"
